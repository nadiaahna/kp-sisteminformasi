            ...
            <div class="row">
                <div class="col-lg-12">
                   <nav class="navbar navbar-light bg-light justify-content-between">
                      ...
                      <form class="form-inline" action="indexm.php" method="get">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2"><center>Ubah</center></th>
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td><a href=<?= "edit.php?No_Badge=". $d['No_Badge'] ?>>Edit</a> | <a onclick="return confirm('yakin untuk menghapus data ?')" href=<?="delete.php?No_Badge=".$d['No_Badge'] ?>>Delete</a></td>
